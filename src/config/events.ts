...
export const homeEventsData: EventData[] = [
  {
    ...
    bodyText:
      "Updates have been applied to the DFEX frontend to inform users of the separation between gmx.io and app.gmx.io",
    buttons: [
      {
        text: "Read More",
...
export const appEventsData: EventData[] = [
  ...
  //   isActive: true,
  //   validTill: "4 May 2022, 12:00",
  //   bodyText: "The DFEX referral program is now live! Get fee discounts and refer traders to earn rewards.",
  //   buttons: [
  //     {
  //       text: "Read More",
  ...
  //   title: "DFEX Arbitrum Odyssey",
  //   isActive: true,
  //   validTill: "3 Jul 2022, 12:00",
  //   bodyText:
  //     "The DFEX Arbitrum Odyssey is taking place this week, all participants will receive prizes. Read on to find out more.",
  //   buttons: [
  //     {
  //       text: "Read More",
  ...
  //   title: "DFEX Arbitrum Odyssey Paused",
  //   isActive: true,
  //   validTill: "3 Jul 2022, 12:00",
  //   bodyText: "The DFEX Arbitrum Odyssey has been paused. Please read the linked post for more information.",
  //   buttons: [
  //     {
  //       text: "Read More",
  ...
  //   bodyText:
  //     "On 6 Jul 2022, updates will be applied to the DFEX frontend to inform users of the separation between gmx.io and app.gmx.io",
  //   buttons: [
  //     {
  //       text: "Read More",
  //       link: "https://medium.com/@gmx.io/gmx-frontend-updates-8d13f2346e1e",
