...
import { ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, MAINNET, TESTNET, POLYGON } from "./chains";
...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [POLYGON]: [
    ...
    },
    {
      ...
      symbol: "BTC",
      decimals: 8,
      address: "0x1f1835f0027e8418ae8281f03f3c9796d4ce8e1c",
      isShortable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/7598/thumb/wrapped_bitcoin_wbtc.png?1548822744",
    },
    {
...
const CHAIN_IDS = [MAINNET, TESTNET, ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, POLYGON];
