          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to GMX.io ("we," "us," or "our"), the informational resource for DFEX Protocol, as defined below.
              </p>
              <p className="body-text">
                GMX.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the DFEX Protocol (the "GMX Protocol," "Protocol," or "GMX DApp"). GMX.io is not an
                available access point to the DFEX Protocol.
              </p>
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the DFEX Referral Program ("Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the DFEX DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the DFEX DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the DFEX DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, DFEX DApp provides you with the Links and Referral Codes necessary to promote the
                DFEX Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the DFEX Protocol offers in any manner you choose unless it misleads someone about
                the DFEX Protocol.
              </p>
              <p className="body-text">
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the DFEX tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                are handled following the directives of the DFEX tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from GMX.io, which the token holders of DFEX determine. Due to
