      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">DFEX</div>
          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                GMX.io is not part of any transaction on the blockchain networks underlying the DFEX Protocol; we do not
                ...
                any crypto assets. You understand that when you interact with any DFEX Protocol smart contracts, you
            ...
            <div className="section">
              ...
              <p className="body-text">
                GMX.io is an informational site for the DFEX Protocol. GMX.io does not operate an exchange platform or
