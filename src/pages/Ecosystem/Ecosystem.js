...
const NETWORK_ICONS = {
  ...
  [ARBITRUM]: polygon24Icon,
  [AVALANCHE]: polygon24Icon,
};
...
export default function Ecosystem() {
  const DFEXPages = [
    {
      title: "DFEX Governance",
      link: "https://gov.gmx.io/",
      linkLabel: "gov.gmx.io",
      about: "DFEX Governance Page",
    ...
    },
    {
      ...
      about: "DFEX Stats Page",
      chainIds: [ARBITRUM, AVALANCHE],
    },
    {
      title: "DFEX Proposals",
      link: "https://snapshot.org/#/gmx.eth",
      linkLabel: "snapshot.org",
      about: "DFEX Proposals Voting page",
      chainIds: [ARBITRUM, AVALANCHE],
    },
    {
      title: "DFEX Announcements",
      link: "https://t.me/GMX_Announcements",
      linkLabel: "t.me",
      about: "DFEX Announcements and Updates",
      chainIds: [ARBITRUM, AVALANCHE],
    },
  ];
  ...
  const dashboardProjects = [
    {
      title: "DFEX Referrals Dashboard",
      link: "https://www.gmxreferrals.com/",
      linkLabel: "gmxreferrals.com",
      about: "Dashboard for DFEX referral stats",
      creatorLabel: "@kyzoeth",
      creatorLink: "https://twitter.com/kyzoeth",
      chainIds: [ARBITRUM, AVALANCHE],
    },
    {
      ...
      about: "DFXE explorer for stats and traders",
      creatorLabel: "@vipineth",
      creatorLink: "https://t.me/vipineth",
      chainIds: [ARBITRUM],
    },
    {
      title: "DFEX Analytics",
      ...
      <div className="default-container page-layout">
        <div>
          <div className="section-title-block">
            ...
            <div className="section-title-content">
              <div className="Page-title">
                <Trans>DFEX Pages</Trans>
              </div>
              <div className="Page-description">
                <Trans>DFEX ecosystem pages.</Trans>
              </div>
            </div>
          </div>
                  ...
                  <div className="App-card-title">
                    ...
                    <div className="App-card-title-icon">
                      {/* {item.chainIds.map((network) => (
                        <img className="polygonIcon" key={network} src={NETWORK_ICONS[network]} alt={NETWORK_ICON_ALTS[network]} />
                      ))} */}
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>Projects developed by the DFEX community.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>DFEX dashboards and analytics.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>Projects integrated with DFEX.</Trans>
            </div>
          </div>
          <div className="DashboardV2-projects">
