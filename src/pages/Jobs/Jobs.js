...
function NoJob() {
  return (
    <Card title="No open positions at DFEX currently">
      <div className="body-para">
        <p className="subheading">
          DFEX is not actively looking for new hires at the moment. However, if you think you can contribute to the
...
//         <ul>
//           <li>Work closely with the DFEX team on the DFEX front-end website.</li>
...
//           </ul>
//           <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 DFEX a year.</p>
