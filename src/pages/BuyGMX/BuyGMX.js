          ...
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>ETH is needed on Arbitrum to purchase DFEX.</Trans>
                <br />
                <Trans>
                  To purchase DFEX on <span onClick={() => onNetworkSelect(AVALANCHE)}>Avalanche</span>, please change
                  your network.
                </Trans>
              </div>
            </div>
        ...
        {chainId === AVALANCHE && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                <Trans>Avax is needed on Avalanche to purchase DFEX.</Trans>
                <br />
                <Trans>
                  {" "}
                  To purchase DFEX on <span onClick={() => onNetworkSelect(ARBITRUM)}>Arbitrum</span>, please change your
                  network.
                </Trans>
              </div>
            </div>
        ...
        {chainId === ARBITRUM && (
          <div className="BuyGMXGLP-panel">
            ...
            <div className="buy-card">
              <div className="section-title-content">
                <div className="card-title">
                  <Trans>Buy DFEX Bonds</Trans>
                </div>
              </div>
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuyGMXGLP-description">
                    <Trans>DFEX bonds can be bought on Olympus Pro with a discount and a small vesting period:</Trans>
                  </div>
                  <div className="buy-gmx">
