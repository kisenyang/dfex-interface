...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedGmx) {
      return t`Vested DFEX not withdrawn`;
    }
    if (hasVestedGlp) {
    ...
    <div className="BeginAccountTransfer Page page-layout">
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          ...
          <br />
          <Trans>This will transfer all your GMX, esGMX, DLP and Multiplier Points to your new account.</Trans>
          <br />
          <Trans>Transfers are only supported if the receiving account has not staked DFEX or DLP tokens before.</Trans>
          <br />
          <Trans>
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedGmx}>
              <Trans>Sender has withdrawn all tokens from DFEX Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedGmx}>
              <Trans>Receiver has not staked DFEX tokens before</Trans>
            </ValidationRow>
