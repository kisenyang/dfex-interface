...
import polygon24Icon from "../../img/dfex/polygon.svg";
...
import { ARBITRUM, AVALANCHE, getChainName, POLYGON } from "config/chains";
...
export default function DashboardV2() {
  ...
  const { infoTokens: infoTokensPolgon } = useInfoTokens(null, POLYGON, active, undefined, undefined);

  const { data: currentFees } = useSWR(
    infoTokensArbitrum[AddressZero].contractMinPrice &&
      infoTokensAvax[AddressZero].contractMinPrice &&
      infoTokensPolgon[AddressZero].contractMinPrice
  ...
  console.log(currentFees, "currentFeescurrentFeescurrentFees", getTokenBySymbol(chainId, "ETH").address);
      ...
      <div className="default-container DashboardV2 page-layout">
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Stats</Trans> <img className="polygonIcon" src={polygon24Icon} alt="polygon24Icon" />
              {/* {chainId === AVALANCHE && <img src={avalanche24Icon} alt="avalanche24Icon" />}
              {chainId === ARBITRUM && <img src={polygon24Icon} alt="polygon24Icon" />} */}
            </div>
            <div className="Page-description">
              <Trans>
                Polygon Total Stats start from 10 Jan 2022
                {/* {totalStatsStartDate} */}.{/* <br />  */}
                {/* For detailed stats:{" "} */}
              </Trans>
              {/* {chainId === ARBITRUM && (
        ...
        <div className="DashboardV2-content">
            ...
            <div className="App-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>Assets Under Management: DFEX staked + DLP pool</span>
                        // <span className="label">{t`Assets Under Management: GMX staked (All chains) + DLP pool (${chainName})`}</span>
                      )}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">DLP Pool</div>
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(aum, USD_DECIMALS, 0, true)}`}
                      position="right-bottom"
                      renderContent={() => <span className="label">Total value of tokens in DLP pool.</span>}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(currentVolumeInfo?.totalVolume, USD_DECIMALS, 0, true)}`}
                      position="right-bottom"
                      renderContent={() => <span className="label">24h Volume on Polygon.</span>}
                    />
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => <span className="label">Long Positions on Polygon.</span>}
                    />
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => <span className="label">Short Positions on Polygon.</span>}
                    />
                ...
                {feeHistory.length ? (
                  <div className="App-card-row">
                    <div className="label">
                      <Trans>Fees since</Trans> 07 Oct 2022.
                      {/* {formatDate(feeHistory[0].to)} */}
                    </div>
                    <div>
                      <TooltipComponent
                        handle={`$${formatAmount(currentFees?.total, USD_DECIMALS, 0, true)}`}
                        position="right-bottom"
                        renderContent={() => <span className="label">Fees on Polygon.</span>}
                      />
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(currentFees?.total, USD_DECIMALS, 0, true)}`}
                      position="right-bottom"
                      renderContent={() => <span className="label">Total Fees on Polygon.</span>}
                    />
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(currentFees?.total, USD_DECIMALS, 0, true)}`}
                      position="right-bottom"
                      renderContent={() => <span className="label">Total Volume on Polygon.</span>}
                    />
          ...
          <div className="Tab-title-section">
            <div className="Page-title">
              Tokens <img className="polygonIcon" src={polygon24Icon} alt="polygon24Icon" />
              {/* {chainId === AVALANCHE && <img src={avalanche24Icon} alt="avalanche24Icon" />}
          ...
          <div className="DashboardV2-token-cards">
                ...
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      ...
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">DFEX</div>
                        <div className="App-card-title-mark-subtitle">DFEX</div>
                      </div>
                      <div>
                        <AssetDropdown assetSymbol="DFEX" />
                      </div>
                    </div>
                  </div>
                  <div className="App-card-divider"></div>
                  <div className="App-card-content">
                    <div className="App-card-row">
                      ...
                      <div>
                        <TooltipComponent
                          handle={`$${formatAmount(currentFees?.total, USD_DECIMALS, 0, true)}`}
                          position="right-bottom"
                          renderContent={() => <span className="label">Price on Polygon.</span>}
                        />
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(totalGmxSupply, GMX_DECIMALS, 0, true)} DFEX</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                      ...
                      <div>
                        <TooltipComponent
                          handle={`$${formatAmount(currentFees?.total, USD_DECIMALS, 0, true)}`}
                          position="right-bottom"
                          renderContent={() => <span className="label">Staked on Polygon.</span>}
                        />
              ...
              <div className="App-card">
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      <div className="App-card-title-mark-icon">
                        <img className="dlp40Icon" src={GLPIcon} alt="glp40Icon" />
                        {/* {chainId === ARBITRUM ? (
                        ...
                        {/* <img src={GLPIcon} alt="avalanche16Icon" className="selected-network-symbol polygonIcon"  /> */}
                      </div>
                      <div className="App-card-title-mark-info">
            ...
            <div className="token-table-wrapper App-card">
              <div className="App-card-title">
                ...
                <img className="polygonIcon" src={polygon24Icon} alt="polygon24Icon" />
              </div>
              <div className="App-card-divider"></div>
              <table className="token-table">
                ...
                <tbody>
                  {visibleTokens.map((token) => {
                    ...
                    console.log(token.address, tokenInfo, "infoTokens contract");
                    ...
                    console.log(
                      tokenInfo,
                      "visibleTokensvisibleTokensvisibleTokensvisibleTokens",
