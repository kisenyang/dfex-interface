        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esDFEX</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">Wallet</div>
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esDFEX</div>
            </div>
            <div className="Exchange-info-row">
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esDFEX tokens that have been converted to DFEX will remain as DFEX tokens.
            <br />
            <br />
            To claim DFEX tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  console.log(gmxPrice, gmxPriceFromArbitrum, gmxPriceFromAvalanche)
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositStakeTokenLabel("staked DFEX + esDFEX + Multiplier Points");
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from DFEX Vault`);
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " DFEX";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esDFEX";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">DFEX</div>
            ...
            <div className="App-card-content">
              <div className="App-card-row">
                ...
                <div>
                  ...
                  <Tooltip
                    ...
                    renderContent={() => (
                      <>
                        Price on Polygon: ${formatAmount(gmxPriceFromArbitrum, USD_DECIMALS, 2, true)}
                        <br />
                        MATIC APR: ${formatAmount(gmxPriceFromAvalanche, USD_DECIMALS, 2, true)}
                      </>
                    )}
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} DFEX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} DFEX ($
                      ...
                      return (
                        <>
                          <div className="Tooltip-row">
                            <span className="label">Escrowed DFEX APR</span>
                    ...
                    renderContent={() => {
                      return (
                        <>
                          ...
                          <div className="Tooltip-row">
                            <span className="label">Escrowed DFEX</span>
                            <span>
              ...
              <div className="App-card-row">
                ...
                <Tooltip
                      ...
                      renderContent={() => (
                        <>
                          Total Staked on Polygon: {formatAmount(arbitrumGmxStaked, 18, 0, true)} DFEX
                        </>
                      )}
                    />
                  ...
                  {totalGmxStaked && (
                    <Tooltip
                      ...
                      renderContent={() => (
                        <>
                          Arbitrum: {formatAmount(arbitrumGmxStaked, 18, 0, true)} DFEX
                          <br />
                          Avalanche: {formatAmount(avaxGmxStaked, 18, 0, true)} DFEX
                        </>
                      )}
                    />
                  )} */}
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} DFEX ($
              ...
              <div className="App-card-options">
                <Link className="default-btn App-card-option" to="/buy_dfex">
                  Buy DFEX
                </Link>
                {active && (
                  <button className="default-btn App-card-option" onClick={() => showStakeGmxModal()}>
                    Stake
                  </button>
                )}
                {active && (
                  <button className="default-btn App-card-option" onClick={() => showUnstakeGmxModal()}>
                    Unstake
                  </button>
                )}
                {active && (
          ...
          <div className="App-card primary StakeV2-total-rewards-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                <div className="label">Escrowed DFEX</div>
                <div>
              ...
              <div className="App-card-bottom">
                ...
                <div className="App-card-options">
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => setIsCompoundModalVisible(true)}>
                      <Trans>Compound</Trans>
                    </button>
                  )}
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => setIsClaimModalVisible(true)}>
                      <Trans>Claim</Trans>
                    </button>
                  )}
                  {!active && (
          ...
          <div className="App-card">
            <div className="App-card-title">DLP</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-divider"></div>
              <div className="App-card-options">
                <Link className="default-btn App-card-option" to="/buy_glp">
                  <Trans>Buy DLP</Trans>
                </Link>
                <Link className="default-btn App-card-option" to="/buy_glp#redeem">
          ...
          <div className="App-card">
            <div className="App-card-title">Escrowed DFEX</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esDFEX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esDFEX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esDFEX ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esDFEX ($
              ...
              <div className="App-card-options">
                {active && (
                  <button className="default-btn App-card-option" onClick={() => showStakeEsGmxModal()}>
                    <Trans>Stake</Trans>
                  </button>
                )}
                {active && (
                  <button className="default-btn App-card-option" onClick={() => showUnstakeEsGmxModal()}>
                    <Trans>Unstake</Trans>
                  </button>
                )}
                {!active && (
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esDFEX tokens to DFEX tokens.
              <br />
              Please read the{" "}
        ...
        <div>
          <div className="StakeV2-cards">
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">DFEX Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  <div className="label">
                  ...
                  <div>
                    <Tooltip
                      ...
                      renderContent={() => {
                        return (
                          <>
                            {formatAmount(processedData.gmxInStakedGmx, 18, 2, true)} DFEX
                            <br />
                            {formatAmount(processedData.esGmxInStakedGmx, 18, 2, true)} esDFEX
                            <br />
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to DFEX from the&nbsp;
                            {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esDFEX deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} DFEX`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
                          ...
                          4,
                          true
                        )} ${t`DFEX tokens can be claimed, use the options under the Total Rewards section to claim them.`}`
                      }
                    />
                  </div>
                </div>
                ...
                <div className="App-card-options">
                  ...
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => showGmxVesterDepositModal()}>
                      <Trans>Deposit</Trans>
                    </button>
                  )}
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => showGmxVesterWithdrawModal()}>
            ...
            <div className="App-card StakeV2-gmx-card">
              <div className="App-card-title">DLP Vault</div>
              <div className="App-card-divider"></div>
              <div className="App-card-content">
                <div className="App-card-row">
                  <div className="label">
                      ...
                      renderContent={() => {
                        return (
                          <>
                            ...
                            to DFEX from the&nbsp;
                            {formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true)} esDFEX deposited for
                            vesting.
                          </>
                        );
                      }}
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} DFEX`}
                      position="right-bottom"
                      renderContent={() =>
                        `${formatKeyAmount(
                          vestingData,
                ...
                <div className="App-card-options">
                  ...
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => showGlpVesterDepositModal()}>
                      <Trans>Deposit</Trans>
                    </button>
                  )}
                  {active && (
                    <button className="default-btn App-card-option" onClick={() => showGlpVesterWithdrawModal()}>
                      <Trans>Withdraw</Trans>
                    </button>
                  )}
                </div>
