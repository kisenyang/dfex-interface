  ...
  return (
    <div className="Stake Page page-layout">
      ...
      <div className="App-warning Stake-warning">
        The <Link to="/migrate">DFEX migration</Link> is in progress, please migrate your GMT, xGMT, GMT-USDG and
        xGMT-USDG tokens.
        <br />
        ...
        <div className="App-card primary">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              <Link className="default-btn" to="/trade" target="_blank" rel="noopener noreferrer">
                Get USDG
              </Link>
              {active && (
                <button
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              ...
              {active && (
                <button className="default-btn" onClick={() => showUnstakeGmtUsdgModal()}>
                  Unstake
                </button>
              )}
              {active && (
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              ...
              {active && (
                <button className="default-btn" onClick={() => showUnstakeXgmtUsdgModal()}>
                  Unstake
                </button>
              )}
              {active && (
        ...
        <div className="App-card">
          ...
          <div className="Stake-card-bottom App-card-content">
            ...
            <div className="App-card-options">
              ...
              {active && (
                <button className="default-btn" onClick={() => showStakeAutoUsdgModal()}>
                  Stake
                </button>
              )}
              {active && (
                <button className="default-btn" onClick={() => showUnstakeAutoUsdgModal()}>
                  Unstake
                </button>
              )}
              {active && (
