      ...
      <div className="Page-title-section mt-0">
        ...
        {isArbitrum && (
          <div>
            <div className="Page-description">
              <br />
              <Trans>You have {formatAmount(esGmxIouBalance, 18, 2, true)} esDFEX (IOU) tokens.</Trans>
              <br />
              <br />
              <Trans>The address of the esDFEX (IOU) token is {esGmxIouAddress}.</Trans>
              <br />
              <Trans>
                The esDFEX (IOU) token is transferrable. You can add the token to your wallet and send it to another
              ...
              <br />
              <Trans>
                After claiming, the esDFEX tokens will be airdropped to your account on the selected network within 7
                days.
              </Trans>
              <br />
              <Trans>The esDFEX tokens can be staked or vested at any time.</Trans>
              <br />
              <Trans>
                Your esDFEX (IOU) balance will decrease by your claim amount after claiming, this is expected behaviour.
              </Trans>
              <br />
              <Trans>
            ...
            <div className="ClaimEsGmx-vesting-options">
              ...
              >
                <div className="ClaimEsGmx-option-label">
                  <Trans>Vest with DFEX on Arbitrum</Trans>
                </div>
              ...
              >
                <div className="ClaimEsGmx-option-label">
                  <Trans>Vest with DFEX on Avalanche</Trans>
                </div>
            ...
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esDFEX tokens at a
                ...
                <Trans>
                  ...
                  esDFEX at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esGMX.
                </Trans>
