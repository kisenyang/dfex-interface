...
import twitterIcon from "../../img/dfex/13.png";
import discordIcon from "../../img/dfex/14.png";
import telegramIcon from "../../img/dfex/15.png";
import githubIcon from "../../img/dfex/16.png";
import mediumIcon from "../../img/dfex/17.png";

import BTCIcon from "../../img/dfex/BTC.png";
import ETHIcon from "../../img/dfex/ETH.png";
import MVXIcon from "../../img/dfex/MVX.png";
import MATICIcon from "../../img/dfex/MATIC.png";
    ...
    <div className="Footer">
      <div className={cx("Footer-wrapper", { home: isHome })}>
        ...
        <div className="footer-price">
          <Row className="footer-price-content">
