...
import { AVALANCHE, getExplorerUrl, POLYGON } from "config/chains";
                          ...
                          {ownerOnOtherChain && !ownerOnOtherChain?.isTaken && (
                            <div className="info">
                              <TooltipWithPortal
                                ...
                                renderContent={() => (
                                  <div>
                                    This code is not yet registered on {chainId !== "Plolygon" ? "Plolygon" : ""}, you
                                    will not receive rebates there.
                                    <br />
                                    <br />
                                    Switch your network to create this code on{" "}
                                    {chainId !== "Plolygon" ? "Plolygon" : ""}.
                                  </div>
                                )}
                              />
                            </div>
                              ...
                              <TooltipWithPortal
                                ...
                                renderContent={() => (
                                  <div>
                                    ...
                                    {chainId !== "Plolygon" ? "Plolygon" : ""}, you will not receive rebates from
                                    traders using this code on {chainId !== "Plolygon" ? "Plolygon" : ""}.
                                  </div>
                                )}
                              />
                            </div>
