        ...
        <div className="MigrationModal-info-box">
          <div className="App-info-row">
            ...
            <div className="align-right">
              {baseAmount &&
                `${formatAmount(baseAmount, 18, 4, true)} DFEX ($${formatAmount(
                  baseAmountUsd,
                  18 + decimals,
                  2,
                  true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {bonusAmount &&
                  `${formatAmount(bonusAmount, 18, 4, true)} DFEX ($${formatAmount(
                    bonusAmountUsd,
                    18 + decimals,
                    2,
                    true
          ...
          {token.bonus > 0 && (
            <div className="App-info-row">
              ...
              <div className="align-right">
                {totalAmount &&
                  `${formatAmount(totalAmount, 18, 4, true)} DFEX ($${formatAmount(
                    totalAmountUsd,
                    18 + decimals,
                    2,
                    true
...
export default function Migration() {
  ...
  return (
    <div className="Migration Page">
      ...
      <div className="Migration-note">Your wallet: {formatAmount(gmxBalance, 18, 4, true)} DFEX</div>
